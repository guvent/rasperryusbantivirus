...
int main(uint argv,char *argc)
{
    ...
    Serialprintln(0,"bkcmd=1");
        Serialwrite(0,255);
        Serialwrite(0,255);
        Serialwrite(0,255);
        
   
        Serialprintln(0,"dim=.800");
        Serialwrite(0,255);
        Serialwrite(0,255);
        Serialwrite(0,255);
        
     //   if(Serialread(0)) {  printf("Command OK!\n");  }
...
int recvRetCommandFinished(uint32_t timeout)
{    
    int ret = 0;
    uint8_t temp[4] = {0};
    ...
    if (ret) 
    {
        printf("?: recvRetCommandFinished ok \n");
    }
    else
    {
        printf("?: recvRetCommandFinished err \n");
    }

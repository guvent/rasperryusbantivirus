        ...
        while (opt)
        {
                ...
                || ret == FCE_FAILEDGET || ret == FCE_MIRRORNOTSYNC)
            {
                if (try < maxattempts)
                {
                    ...
                    lprintf(1,0,0,"5 Saniye Sonra  TekrarDeneyecek");
                    sleep (1);
                    lprintf(0,1,0,"4");
                    sleep (1);
                    lprintf(0,1,0,"3");
                ...
                else
                {
                    ...
                    if (!opt)
                    {
                        logg ("Güncelleme Başarısız! Internet Bağlantınızı Kontrol Edin veya Konfigurasyon Dosyasını Gözden Geçirin '%s',Daha Fazla Ayrıntı Için : http://www.clamav.net/doc/mirrors-faq.html \n", cfgfile);
                        
                        lprintf(1,0,0,"!!.Guncelleme...Basarisiz.!!");
                        sleep(2);
                        lprintf(1,0,0,"Lutfen.Internet.Baglantinizi");
                        sleep(2);
                        lprintf(1,0,0,"Kontrol.Edin..!!");
                        sleep(2);
                        lprintf(1,0,0,"!!.Guncelleme...Basarisiz.!!");
                        sleep(2);
                        lprintf(1,0,0,"Lutfen.Internet.Baglantinizi");
...
main (int argc, char **argv)
{
  ...
  //  system("lxterminal -e sudo /home/pi/Desktop/clamav-0.98.7/clamscan/clamscan");

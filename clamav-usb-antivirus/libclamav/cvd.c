...
static int cli_untgz(int fd, const char *destdir)
{
    ...
    lprintf(1,0,0,"VT Denetleniyor Lutfen Bekleyin!");
    while(1) {

	//ltprogress("Un Tar/Gz...    ");
...
int cli_cvdload(FILE *fs, struct cl_engine *engine, unsigned int *signo, unsigned int options, unsigned int dbtype, const char *filename, unsigned int chkonly)
{
	...
	if(cvd.stime > s_time) {
		...
		cli_warnmsg("******************************************************\n");
		cli_warnmsg("***      Veritabanı Tarih/Saat Bilgisi Sorunlu     ***\n");
		cli_warnmsg("***         Tarih Saat Ayarını Kontrol Edin        ***\n");
		cli_warnmsg("******************************************************\n");
                
                lprintf(1,0,0,"Tarih-Saat AyariLutfen Duzeltin");
            sleep(6);
	    ...
	    cli_warnmsg("**************************************************\n");
	    cli_warnmsg("***  Veritabanı Eski Olabilir! En Az 7 Gündür  ***\n");
	    cli_warnmsg("***   Lütfen Güncellemeleri Kontrol Edin!      ***\n");
	    cli_warnmsg("**************************************************\n");
            
            lprintf(1,0,0,"VT Eski! Lutfen   Guncelleyin ");
            sleep(6);
            lprintf(1,0,0,"VT Denetleniyor");
            lprintf(0,0,1,"Lutfen Bekleyin");
	...
	cli_warnmsg("***********************************************************\n");
	cli_warnmsg("*** Uygulama Versiyonu Eski Güncellemeleri Kontrol Edin ***\n");
	cli_warnmsg("***   Bilgi: http://www.clamav.net/doc/install.html     ***\n");
	cli_warnmsg("***********************************************************\n");
        lprintf(1,0,0,"Uygulama Eski!  Lutfen Guncellyn");
        sleep(6);
        lprintf(1,0,0,"VT Denetleniyor");
        lprintf(0,0,1,"Lutfen Bekleyin");
